                        ...
                        <div class="background_card">
                            <div class="row align-items-center">
                                <div class="col-sm-4 col-md-4 col-lg-4 col-6">
                                    <div class="kotak_img">
                                        <img src="<?= base_url('assets_admin/dist/img/dosen/') . $val['Img'] ?>"
                                            alt="<?= $val['Name'] ?>"
                                            style="width: 100%; border-radius: 5px; object-fit: cover;">
                                    </div>
                                </div>
                                <div class="col-sm-8 col-md-8 col-lg-8 col-12">
                                    <h4 style="font-size: 1.1rem; margin-bottom: 5px;"><?= $val['Title'] ?></h4>
                                    <p style="color: #666;"><?= $val['Name'] ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <?php else : ?>
                <div class="col-12">
                    <div class="alert alert-light text-center py-5" style="border: 2px dashed #ddd; border-radius: 10px;">
                        ...
                        <h4 class="text-muted">Data Staff Belum Tersedia</h4>
                        <p class="text-secondary">Mohon maaf, daftar staff administrasi saat ini belum tersedia atau sedang diperbaharui.</p>
                    </div>
                </div>
            <?php endif; ?>
        </div>
