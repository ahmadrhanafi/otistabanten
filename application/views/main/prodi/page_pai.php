    ...
    <div class="container">
        <div class="row row_utama">
            ...
            <div class="col-sm-8 col-md-8 col-lg-8 col-12">
                ...
                <hr>
                <p>Profi Singkat</p>
                <p>Pendidikan agama Islam memuat dua kata yang digabung menjadi satu yakni pendidikan dan agama Islam.
                ...
                <div class="body">
                    ...
                    <div class="isi_tujuan" style="display:none;">
                        <h4>Tujuan Pendidikan Agama Islam</h4>
                    ...
                    <div class="isi_strategi" style="display:none;">
                        <h4>Strategi Pengembangan PAI</h4>
                    ...
                    <div class="isi_pengelola" style="display:none;">
                        <h4>Pengelola Program Studi PAI</h4>
                        <p>
                        </p>
